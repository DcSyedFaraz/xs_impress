...
return new class extends Migration
{
    ...
    {
        Schema::create('product_price_country_based', function (Blueprint $table) {
            $table->id();
            $table->foreignId('product_id')->constrained(
                table: 'products', indexName: 'product_price_country_based_products_id'
            )->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('product_price_country_baseds');
    }
};
