...
Route::middleware('auth')->group(function () {
    ...
    Route::get('product/deleted', [ProductController::class, 'deleteProducts'])->name('product.deleted');
    ...
    Route::get('supplier', [SupplierController::class, 'suppliers'])->name('suppliers');
